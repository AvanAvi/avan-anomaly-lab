...
export default function Writings() {
  ...
  const [showScienceTransition, setShowScienceTransition] = useState(false);
  const [showPhilosophyTransition, setShowPhilosophyTransition] = useState(false);
  ...
  const handlePhilosophyClick = () => {
    ...
    document.documentElement.style.overflow = 'hidden';
    document.body.style.overflow = 'hidden';
    setShowPhilosophyTransition(true);
  };
